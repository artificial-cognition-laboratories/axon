// code-review — a prompt package: one or more units of work, shareable on their own.
//
...
export default definePrompt({
    description: "Review a diff on two independent axes — repo standards, and the spec it came from.",
})
