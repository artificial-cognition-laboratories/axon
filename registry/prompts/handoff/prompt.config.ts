// handoff — a prompt package: one or more units of work, shareable on their own.
//
...
export default definePrompt({
    description: "Compact a session into a document another agent can resume the work from.",
})
