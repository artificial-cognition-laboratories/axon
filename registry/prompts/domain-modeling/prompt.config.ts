// domain-modeling — a prompt package: one or more units of work, shareable on their own.
//
...
export default definePrompt({
    description: "Sharpen a project's domain language and record the decisions worth keeping.",
})
