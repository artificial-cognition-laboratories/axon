// codebase-design — a prompt package: one or more units of work, shareable on their own.
//
...
export default definePrompt({
    description: "Design deep modules — small interfaces, clean seams, testable through them.",
})
