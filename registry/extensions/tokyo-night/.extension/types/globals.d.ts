...
declare global {
     ...
     */
    type CommandPath = string | readonly string[]
     ...
     */
    type ComponentName = RegistryName<AxonComponentRegistry>
     ...
     */
    type RegistryName<R> = keyof R extends never ? string : keyof R & string
     ...
     */
    type LineName = RegistryName<AxonLineRegistry>

    /**
     * Every palette name known at generation time.
     */
    type PaletteName = RegistryName<AxonPaletteRegistry>

    /**
     * Every command path known at generation time, space-joined.
     */
    type CommandName = RegistryName<AxonCommandRegistry>
    ...
    interface AxonComponentRegistry {}
    // eslint-disable-next-line @typescript-eslint/no-empty-object-type
    interface AxonLineRegistry {}
    // eslint-disable-next-line @typescript-eslint/no-empty-object-type
    interface AxonPaletteRegistry {}
    // eslint-disable-next-line @typescript-eslint/no-empty-object-type
    interface AxonCommandRegistry {}
     ...
     */
    type LineDefinition = LineContent | readonly string[]
     ...
     * declared.
     */
    type AxonLineEntry = LineName | AxonLinePlacement
     ...
     */
    type LinePosition = "up" | "down" | number
    ...
    type CommandFailedPayload = CommandPayload & {
    ...
    type TuiHooks = TuiGateHooks & TuiNotifyHooks

    type TuiHookName = keyof TuiHooks
     ...
     */
    type IconSet = "auto" | "nerd" | "unicode" | "none"
